...
Ho : Null Hypothesis - There is  no significance difference (No changes) in response time between the congruent and incongruent words test.

Ha : Alternative Hypotheis - There is a significance difference in response time between the congruent and incongruent words test.
...
### 5. Now, perform the statistical test and report your results. What is your confidence level and your critical statistic value? Do you reject the null hypothesis or fail to reject it? Come to a conclusion in terms of the experiment task. Did the results match up with your expectations?
        ...
        Ho:  No changes in the Response time for the incongruent words tests than the congruent words tests
                       
        Ha:  Noticeable increase in the Response time duration between the congruent and incongruent words tests.
